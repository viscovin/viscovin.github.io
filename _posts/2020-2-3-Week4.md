...
3. We will now inject SQL using the Username input field in an attempt to bypass authentication. Enter `' OR 1=1;--` as the username and `abc` as the password. Click 'Submit'.
